...
public class SList {
  ...
  private SListNode tail;//在单链表中添加tail指针可以简化insertEnd从liner-time到constant-time，但删除末节点还是很难
  private int size;
  ...
  public static void main (String[] args) {
    ...
    System.out.println("Here is a new list: "+ slist.toString());
    slist.insertFront(new Integer(3));
    slist.insertEnd(new Integer(15));
    System.out.println("Here is a changed list: "+ slist.toString());
  }
